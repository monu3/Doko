...
const Header = lazy(
  () => import("@/websitesThemes/themes/components/shoesShop/header")
);
import ProductListPage from "./components/productListPage";
import ProductDetailPage from "./components/productDetailPage";
import Hero from "@/websitesThemes/themes/components/shoesShop/hero";
import Footer from "@/websitesThemes/themes/components/shoesShop/footer";
