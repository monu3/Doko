      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          onClick={() => handleHomeClick(onHomeSelect)}>
            ...
            />
            <span className="text-xl font-bold text-blue-800">{shop?.businessName}</span>
          </div>
          ...
          <nav className="hidden md:flex space-x-8">
            ...
            <div
            className={`cursor-pointer text-blue-700 hover:text-blue-600 font-medium transition-colors
              ${!selectedCategory ? 'text-blue-800 underline' : 'text-gray-600'}`}
            onClick={() => handleHomeClick(onHomeSelect)}
            >
              Home
            </div>
            ...
            {dropdownCategories.length > 0 && (
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button
                    variant="ghost"
                    className={`hover:text-blue-600 font-medium transition-colors p-0 h-auto ${
            ...
            <div className="flex flex-col space-y-3">
              ...
              <div
                className={`text-blue-700 font-medium cursor-pointer ${
                  !selectedCategory ? "text-blue-800 underline" : ""
                }`}
                onClick={() => {
